...
public class PropertiesPanel extends JPanel {
	...
	public PropertiesPanel() {
		...
		xTextField.setPreferredSize(new Dimension(70,  25));
		...
		yTextField.setPreferredSize(new Dimension(70,  25));
		...
		mapPointTypesComboBox.setPreferredSize(new Dimension(100, 25));
